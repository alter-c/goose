...
def parse_args():
    ...
    parser.add_argument("-H", "--nhid", type=int, default=16)
    parser.add_argument(
        "--aggr",
        type=str,
        default="mean",
...
if __name__ == "__main__":
    ...
    # load data and init model (#TODO if needed, add feat_size here)
    ...
    args.feat_size_list = representation.REPRESENTATIONS[args.rep].feature_size_list
    args.in_feat = train_loader.dataset[0].x.shape[1]
    args.out_feat = 1  # regression task
    ...
    try:
        ...
        for e in range(epochs):
            ...
            if combined_metric < best_metric:
                ...
                best_dict = model.model.state_dict() # model params
                best_epoch = e
